...
Sends an image to Gemini and returns a text description or analysis.

Usage:
    # Describe an image (default accessibility prompt)
    python3 image_to_text.py -i photo.png

    # Custom analysis prompt
    python3 image_to_text.py -i diagram.png "Extract all text visible in this diagram"

    # Save output to file
    python3 image_to_text.py -i chart.png "Describe the data trends" -o analysis.txt

    # Pipe image from stdin
    cat photo.png | python3 image_to_text.py "Describe this image"
...
def main():
    parser = argparse.ArgumentParser(description="Analyze an image using Google Gemini vision.")
    parser.add_argument("prompt", type=str, nargs="?", default=DEFAULT_PROMPT,
                        help="Text prompt to guide the analysis.")
